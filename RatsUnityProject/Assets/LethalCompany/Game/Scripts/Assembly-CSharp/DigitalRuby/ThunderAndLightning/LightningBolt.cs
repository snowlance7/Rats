...
namespace DigitalRuby.ThunderAndLightning
{
	public class LightningBolt
	{
		public class LineRendererMesh
		{
			...
			public LineRendererMesh(LightningBoltDependencies dependencies)
			{
				dependencies.ThreadState.AddActionForMainThread(delegate
				{
					...
					ShadowCastingMode shadowCastingMode = (meshRendererBolt.shadowCastingMode = ShadowCastingMode.Off);
					meshRenderer.shadowCastingMode = shadowCastingMode;
					MeshRenderer meshRenderer2 = meshRendererGlow;
					ReflectionProbeUsage reflectionProbeUsage = (meshRendererBolt.reflectionProbeUsage = ReflectionProbeUsage.Off);
					meshRenderer2.reflectionProbeUsage = reflectionProbeUsage;
					MeshRenderer meshRenderer3 = meshRendererGlow;
					LightProbeUsage lightProbeUsage = (meshRendererBolt.lightProbeUsage = LightProbeUsage.Off);
					meshRenderer3.lightProbeUsage = lightProbeUsage;
		...
		private Transform RenderLightningBolt(LightningBoltQualitySetting quality, int generations, int startGroupIndex, int endGroupIndex, LightningBoltParameters parameters)
		{
			...
			{
				LightningBoltSegmentGroup lightningBoltSegmentGroup2 = segmentGroups[num];
