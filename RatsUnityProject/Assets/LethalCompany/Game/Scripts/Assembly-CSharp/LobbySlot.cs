...
public class LobbySlot : MonoBehaviour
{
	...
	public UnityEngine.UI.Image modStateUnknownIcon;

	public UnityEngine.UI.Image modStateTrueIcon;
	...
	public void SetModdedIcon(ModdedState moddedState)
	{
		switch (moddedState)
		{
		case ModdedState.Unknown:
			modStateUnknownIcon.enabled = true;
			break;
		case ModdedState.Modded:
			modStateTrueIcon.enabled = true;
			break;
		}
	}
