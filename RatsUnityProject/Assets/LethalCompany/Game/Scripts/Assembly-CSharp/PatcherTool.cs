...
public class PatcherTool : GrabbableObject
{
	...
	public override void LateUpdate()
	{
		...
		if (isShocking && shockedTargetScript != null && playerHeldBy != null && !playerHeldBy.isPlayerDead && !playerHeldBy.inAnimationWithEnemy && !insertedBattery.empty && !playerHeldBy.inAnimationWithEnemy)
		{
