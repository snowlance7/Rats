...
public class SelectableLevel : ScriptableObject
{
	...
	public IndoorMapHazard[] indoorMapHazards;
	...
	[Space(3f)]
	public int maxInsideDiversityPowerCount = 100;

	public int maxOutsideDiversityPowerCount = 100;

	[Space(3f)]
	public List<SpawnableEnemyWithRarity> Enemies = new List<SpawnableEnemyWithRarity>();

	public OverrideEnemyRarity specialEnemyRarity;
